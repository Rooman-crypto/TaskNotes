...
class MainWindow(QMainWindow):
    ...
    def task_ui(self):
        ...
        if self.task_list.currentText():
            ...
            self.date_label.setText(
                self.stored_tasks[self.task_list.currentText()]["date"]
            )
    ...
    def save_task(self):
        ...
        with open("tasksSaved.json", "w", encoding="utf-8") as v:
            json.dump(self.stored_tasks, v)
    ...
    def load_task(self):
        ...
        try:
            ...
            if self.stored_tasks != copy:
                ...
                self.label1.setVisible(True)
                self.label1.setText(
                    f"Successfully added {len(self.stored_tasks)} tasks"
                )
                self.description_field.setEnabled(True)
            else:
...
if __name__ == "__main__":
    ...
    with open(resource_path("MacOS.qss"), "r", encoding="utf-8") as f:
